...
function historicoPeriodoEdicaoEmpreendimento(id) {
...
function format(d) {
    ...
    return (
        ...
        '<dt>Ano: <span style="color: #6699FF;font-weight: bold;">' + d.AnoBase + '</span></dt>' +

        '<dt>Data Inicial: <span style="color: #6699FF;">' + d.DataInicial + '</span></dt>' +

        '<dt>Data Final: <span style="color: #6699FF;">' + d.DataFinal + '</span></dt>' +
