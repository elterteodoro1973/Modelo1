...
function format(d) {
    ...
    return (
        ...
        '<dt>Nome: <span style="color: #6699FF;font-weight: normal;">' + d.Nome + '</span><br></dt>' +

        '<dt>Descrição: <span style="color: #6699FF;font-weight: normal;">' + d.Descricao + '</span><br></dt>' +
