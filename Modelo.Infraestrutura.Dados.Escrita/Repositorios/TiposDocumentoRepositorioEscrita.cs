...
{
    public class TiposDocumentoRepositorioEscrita : BaseRepositorioEscrita<TiposDocumento>, ITiposDocumentoRepositorioEscrita
    {
        private readonly DaeeCobrancaContexto _contexto;
        public TiposDocumentoRepositorioEscrita(DaeeCobrancaContexto contexto) : base(contexto)
        {
            _contexto = contexto;
        }
    }
