...
{
    public class DominalidadeRepositorioEscrita : BaseRepositorioEscrita<Dominalidade>, IDominalidadeRepositorioEscrita
    {
        private readonly DaeeCobrancaContexto _contexto;
        public DominalidadeRepositorioEscrita(DaeeCobrancaContexto contexto) : base(contexto)
        {
            _contexto = contexto;
        }
    }
