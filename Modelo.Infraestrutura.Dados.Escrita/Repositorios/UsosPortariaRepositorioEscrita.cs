...
{
    public class UsosPortariaRepositorioEscrita : BaseRepositorioEscrita<UsosPortaria>, IUsosPortariaRepositorioEscrita
    {
        private readonly DaeeCobrancaContexto _contexto;
        public UsosPortariaRepositorioEscrita(DaeeCobrancaContexto contexto) : base(contexto)
        {
            _contexto = contexto;
        }
    }
