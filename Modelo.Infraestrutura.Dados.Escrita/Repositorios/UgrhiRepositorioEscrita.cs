...
{
    public class UgrhiRepositorioEscrita : BaseRepositorioEscrita<Ugrhi>, IUgrhiRepositorioEscrita
    {
        private readonly DaeeCobrancaContexto _contexto;
        public UgrhiRepositorioEscrita(DaeeCobrancaContexto contexto) : base(contexto)
        {
            _contexto = contexto;
        }
    }
