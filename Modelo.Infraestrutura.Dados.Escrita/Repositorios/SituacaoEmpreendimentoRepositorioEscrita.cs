...
{
    public class SituacaoEmpreendimentoRepositorioEscrita : BaseRepositorioEscrita<SituacaoEmpreendimento>, ISituacaoEmpreendimentoRepositorioEscrita
    {
        private readonly DaeeCobrancaContexto _contexto;
        public SituacaoEmpreendimentoRepositorioEscrita(DaeeCobrancaContexto contexto) : base(contexto)
        {
            _contexto = contexto;
        }
    }
